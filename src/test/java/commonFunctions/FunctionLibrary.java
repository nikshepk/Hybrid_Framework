...
public class FunctionLibrary {
	...
	//method for capture supplier number
		...
		//method for capture Purchase number
				public static void capurePurcNum(String LocatorType,String LocatorValue)throws Throwable
				{
					String purchaseNum ="";
					if(LocatorType.equalsIgnoreCase("xpath"))
					{
				...
				//method for selecting day , month , year and time
				public static void CalenderAction() throws Throwable
				{
					Thread.sleep(4000);
					driver.findElement(By.xpath("//span[@class='glyphicon glyphicon-calendar']")).click();
					Thread.sleep(4000);
					driver.findElement(By.xpath("//td[normalize-space()='Now']")).click();
					Thread.sleep(4000);
					driver.findElement(By.xpath("//td[@class='day selected today']")).click();
				}
				
				//method for capture Total balance number
				public static void capureTotBal(String LocatorType,String LocatorValue)throws Throwable
				{
					String totalbal ="";
					if(LocatorType.equalsIgnoreCase("xpath"))
					{
						totalbal = driver.findElement(By.xpath(LocatorValue)).getAttribute("value");
					}
					if(LocatorType.equalsIgnoreCase("name"))
					{
						totalbal = driver.findElement(By.name(LocatorValue)).getAttribute("value");
					}
					if(LocatorType.equalsIgnoreCase("id"))
					{
						totalbal = driver.findElement(By.id(LocatorValue)).getAttribute("value");
					}
					FileWriter fw = new FileWriter("./CaptureData/totalBal.txt");
					BufferedWriter bw = new BufferedWriter(fw);
					bw.write(totalbal);
					bw.flush();
					bw.close();
